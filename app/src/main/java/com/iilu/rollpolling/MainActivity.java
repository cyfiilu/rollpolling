    ...
    private void initView() {
        ...
        if (rollPollingFragment != null) {
            rollPollingFragment.setImgHeight(160) // set img height, default 150dp
                    ...
                    .setIndicatorGravity(RollPollingFragment.RIGHT_BOTTOM) // set indicator position, default Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;
